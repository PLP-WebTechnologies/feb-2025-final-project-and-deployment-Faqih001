...
// Button component that uses the cva function to create a buttonVariants object
...
// ButtonProps interface that extends the ButtonHTMLAttributes interface and the VariantProps interface
